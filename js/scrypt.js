document.addEventListener("DOMContentLoaded", (e) => {
    ...
    ShowMobileMenu();
    tabs(tabs_privileges,"nav-link-description active-privileges",
        ".nav-link-description.active-privileges",
        "active-privileges",
        ".tab-pane.active-block-privileges",
        "active-block-privileges");
    tabs(tabs_events,"nav-link-description-events active-event",
    ".nav-link-description-events.active-event",
    "active-event",
    ".tab-pane.active-block-event",
    ".active-block-event");
});
